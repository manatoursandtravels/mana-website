    ...
    <>
      ...
      <div className={styles.serviceHero}>
        <div className="container">
          ...
          <h1 className={styles.heroTitle}>Kadapa to Gandikota Cab</h1>
          <p className={styles.heroSubtitle}>
            Comfortable AC cab from Kadapa to Gandikota. Transparent pricing. Experienced driver. Available 24/7.
          </p>
          <div className={styles.routeInfo}>
            ...
            <div className={styles.routeInfoItem}>
              <div className={styles.routeInfoValue}>Rs.2,799</div>
        ...
        <div className="container">
          <div className={styles.contentGrid}>
            <div className={styles.mainCol}>
              <h2>Kadapa to Gandikota Cab Fare</h2>
              ...
              <table className="rate-table">
                ...
                <tbody>
                  <tr><td>One Way / Day Trip</td><td className="price">Rs.2,799</td><td>Driver + AC + Fuel</td></tr>
                  <tr><td>Round Trip</td><td className="price">Rs.2,799</td><td>Driver + AC + Fuel + Wait</td></tr>
                </tbody>
              </table>
